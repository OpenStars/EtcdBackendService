...
class TDataServiceIf {
 public:
  ...
  virtual TErrorCode::type putData(const TKey key, const TCommentItem& data) = 0;
  virtual void getListData(TListDataResult& _return, const std::vector<TKey> & listKey) = 0;
...
class TDataServiceNull : virtual public TDataServiceIf {
 public:
  ...
  TErrorCode::type putData(const TKey /* key */, const TCommentItem& /* data */) {
...
typedef struct _TDataService_getListData_args__isset {
  _TDataService_getListData_args__isset() : listKey(false) {}
  bool listKey :1;
...
class TDataServiceClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type putData(const TKey key, const TCommentItem& data);
  void send_putData(const TKey key, const TCommentItem& data);
  TErrorCode::type recv_putData();
  void getListData(TListDataResult& _return, const std::vector<TKey> & listKey);
  void send_getListData(const std::vector<TKey> & listKey);
...
class TDataServiceMultiface : virtual public TDataServiceIf {
 ...
 public:
  ...
  void getListData(TListDataResult& _return, const std::vector<TKey> & listKey) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->getListData(_return, listKey);
    }
    ifaces_[i]->getListData(_return, listKey);
    return;
  }
...
class TDataServiceConcurrentClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type putData(const TKey key, const TCommentItem& data);
  int32_t send_putData(const TKey key, const TCommentItem& data);
  TErrorCode::type recv_putData(const int32_t seqid);
  void getListData(TListDataResult& _return, const std::vector<TKey> & listKey);
  int32_t send_getListData(const std::vector<TKey> & listKey);
