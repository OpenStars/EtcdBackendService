...
type TCommentItem struct {
  Idcomment int64 `thrift:"idcomment,1" db:"idcomment" json:"idcomment"`
  ...
  Timestamps int64 `thrift:"timestamps,8" db:"timestamps" json:"timestamps"`
  Parentcommentid *int64 `thrift:"parentcommentid,9" db:"parentcommentid" json:"parentcommentid,omitempty"`
  MapExtend map[string]string `thrift:"mapExtend,10" db:"mapExtend" json:"mapExtend"`
}
...
func (p *TCommentItem) GetIdcomment() int64 {
  return p.Idcomment
}
...
func (p *TCommentItem) writeField8(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("timestamps", thrift.I64, 8); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 8:timestamps: ", p), err) }
  if err := oprot.WriteI64(int64(p.Timestamps)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.timestamps (8) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 8:timestamps: ", p), err) }
  return err
}

func (p *TCommentItem) writeField9(oprot thrift.TProtocol) (err error) {
  if p.IsSetParentcommentid() {
    if err := oprot.WriteFieldBegin("parentcommentid", thrift.I64, 9); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 9:parentcommentid: ", p), err) }
    if err := oprot.WriteI64(int64(*p.Parentcommentid)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.parentcommentid (9) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 9:parentcommentid: ", p), err) }
  }
  return err
}

func (p *TCommentItem) writeField10(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("mapExtend", thrift.MAP, 10); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 10:mapExtend: ", p), err) }
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 10:mapExtend: ", p), err) }
  return err
}
...
type TDataService interface {
  ...
  //  - Key
  //  - Data
  PutData(ctx context.Context, key int64, data *TCommentItem) (r TErrorCode, err error)
  // Parameters:
  //  - ListKey
  GetListData(ctx context.Context, listKey []int64) (r *TListDataResult_, err error)
  // Parameters:
  //  - Key
...
//  - Key
//  - Data
func (p *TDataServiceClient) PutData(ctx context.Context, key int64, data *TCommentItem) (r TErrorCode, err error) {
...
// Parameters:
//  - ListKey
func (p *TDataServiceClient) GetListData(ctx context.Context, listKey []int64) (r *TListDataResult_, err error) {
...
type TDataServiceGetListDataArgs struct {
  ListKey []int64 `thrift:"listKey,1" db:"listKey" json:"listKey"`
}
...
func (p *TDataServiceGetListDataArgs) GetListKey() []int64 {
  return p.ListKey
}
