...
import (
	...
	"openstars/enduservtp"
)

var _ = enduservtp.GoUnusedProtection__
...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  TErrorCode putData(TKey key, TEndUserVTP data)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := enduservtp.NewTDataServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "getMultiData":
    ...
    containerStruct0 := enduservtp.NewTDataServiceGetMultiDataArgs()
