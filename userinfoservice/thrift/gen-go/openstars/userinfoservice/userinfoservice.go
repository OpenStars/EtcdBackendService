...
func (p TRole) String() string {
  switch p {
  case TRole_Enter_News_Content: return "Enter_News_Content"
  case TRole_Create_Hashtag_For_News: return "Create_Hashtag_For_News"
  case TRole_Choose_Time: return "Choose_Time"
  case TRole_Send_News_Aggregate: return "Send_News_Aggregate"
  }
  return "<UNSET>"
}
...
func TRoleFromString(s string) (TRole, error) {
  switch s {
  case "Enter_News_Content": return TRole_Enter_News_Content, nil 
  case "Create_Hashtag_For_News": return TRole_Create_Hashtag_For_News, nil 
  case "Choose_Time": return TRole_Choose_Time, nil 
  case "Send_News_Aggregate": return TRole_Send_News_Aggregate, nil 
  }
...
func (p TTypePosition) String() string {
  switch p {
  case TTypePosition_BOSS: return "BOSS"
  case TTypePosition_DEPUTY: return "DEPUTY"
  case TTypePosition_MEMBER: return "MEMBER"
  }
  return "<UNSET>"
}
...
func TTypePositionFromString(s string) (TTypePosition, error) {
  switch s {
  case "BOSS": return TTypePosition_BOSS, nil 
  case "DEPUTY": return TTypePosition_DEPUTY, nil 
  case "MEMBER": return TTypePosition_MEMBER, nil 
  }
...
func (p TTierID) String() string {
  switch p {
  case TTierID_TIER_1: return "TIER_1"
  case TTierID_TIER_2: return "TIER_2"
  case TTierID_TIER_3: return "TIER_3"
  case TTierID_Area_Organization: return "Area_Organization"
  case TTierID_TTTS: return "TTTS"
  case TTierID_QBTS: return "QBTS"
  case TTierID_QTHT: return "QTHT"
  }
  return "<UNSET>"
}
...
func TTierIDFromString(s string) (TTierID, error) {
  switch s {
  case "TIER_1": return TTierID_TIER_1, nil 
  case "TIER_2": return TTierID_TIER_2, nil 
  case "TIER_3": return TTierID_TIER_3, nil 
  case "Area_Organization": return TTierID_Area_Organization, nil 
  case "TTTS": return TTierID_TTTS, nil 
  case "QBTS": return TTierID_QBTS, nil 
  case "QTHT": return TTierID_QTHT, nil 
  }
...
func (p TStatus) String() string {
  switch p {
  case TStatus_ACTIVE: return "ACTIVE"
  case TStatus_BANNED: return "BANNED"
  case TStatus_DELETED: return "DELETED"
  }
  return "<UNSET>"
}
...
func TStatusFromString(s string) (TStatus, error) {
  switch s {
  case "ACTIVE": return TStatus_ACTIVE, nil 
  case "BANNED": return TStatus_BANNED, nil 
  case "DELETED": return TStatus_DELETED, nil 
  }
