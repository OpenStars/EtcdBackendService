...
import (
	...
	"github.com/OpenStars/EtcdBackendService/userinfoservice/transports"
...
func (m *userinforservice) handlerEventChangeEndpoint(ep *GoEndpointBackendManager.EndPoint) {
	m.host = ep.Host
	m.port = ep.Port
