...
//  - Timestamp
//  - MapExt
type TCallLog struct {
  CallPhone string `thrift:"CallPhone,1" db:"CallPhone" json:"CallPhone"`
  CallStatus string `thrift:"CallStatus,2" db:"CallStatus" json:"CallStatus"`
  DeviceCall string `thrift:"DeviceCall,3" db:"DeviceCall" json:"DeviceCall"`
  ListenTime int64 `thrift:"ListenTime,4" db:"ListenTime" json:"ListenTime"`
  PostOffice string `thrift:"PostOffice,5" db:"PostOffice" json:"PostOffice"`
  PostmanId string `thrift:"PostmanId,6" db:"PostmanId" json:"PostmanId"`
  PostmanName string `thrift:"PostmanName,7" db:"PostmanName" json:"PostmanName"`
  ReceiverPhone string `thrift:"ReceiverPhone,8" db:"ReceiverPhone" json:"ReceiverPhone"`
  RingTime int64 `thrift:"RingTime,9" db:"RingTime" json:"RingTime"`
  Type string `thrift:"Type,10" db:"Type" json:"Type"`
  CallType string `thrift:"CallType,11" db:"CallType" json:"CallType"`
  Status string `thrift:"Status,12" db:"Status" json:"Status"`
  Source string `thrift:"Source,13" db:"Source" json:"Source"`
  Timestamp int64 `thrift:"Timestamp,14" db:"Timestamp" json:"Timestamp"`
  MapExt map[string]string `thrift:"mapExt,15" db:"mapExt" json:"mapExt"`
}

func NewTCallLog() *TCallLog {
  return &TCallLog{}
}


func (p *TCallLog) GetCallPhone() string {
  return p.CallPhone
}

func (p *TCallLog) GetCallStatus() string {
  return p.CallStatus
}

func (p *TCallLog) GetDeviceCall() string {
  return p.DeviceCall
}

func (p *TCallLog) GetListenTime() int64 {
  return p.ListenTime
}

func (p *TCallLog) GetPostOffice() string {
  return p.PostOffice
}

func (p *TCallLog) GetPostmanId() string {
  return p.PostmanId
}

func (p *TCallLog) GetPostmanName() string {
  return p.PostmanName
}

func (p *TCallLog) GetReceiverPhone() string {
  return p.ReceiverPhone
}

func (p *TCallLog) GetRingTime() int64 {
  return p.RingTime
}

func (p *TCallLog) GetType() string {
  return p.Type
}

func (p *TCallLog) GetCallType() string {
  return p.CallType
}

func (p *TCallLog) GetStatus() string {
  return p.Status
}

func (p *TCallLog) GetSource() string {
  return p.Source
}

func (p *TCallLog) GetTimestamp() int64 {
  return p.Timestamp
}

func (p *TCallLog) GetMapExt() map[string]string {
  return p.MapExt
}
func (p *TCallLog) Read(iprot thrift.TProtocol) error {
...
func (p *TCallLog)  ReadField1(iprot thrift.TProtocol) error {
...
func (p *TCallLog)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField3(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField4(iprot thrift.TProtocol) error {
...
func (p *TCallLog)  ReadField5(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField6(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField7(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField8(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField9(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TCallLog)  ReadField10(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField11(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField12(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField13(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TCallLog)  ReadField14(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TCallLog)  ReadField15(iprot thrift.TProtocol) error {
...
func (p *TCallLog) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("TCallLog"); err != nil {
...
func (p *TCallLog) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("CallPhone", thrift.STRING, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:CallPhone: ", p), err) }
  if err := oprot.WriteString(string(p.CallPhone)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.CallPhone (1) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 1:CallPhone: ", p), err) }
  return err
}

func (p *TCallLog) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("CallStatus", thrift.STRING, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:CallStatus: ", p), err) }
  if err := oprot.WriteString(string(p.CallStatus)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.CallStatus (2) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 2:CallStatus: ", p), err) }
  return err
}

func (p *TCallLog) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("DeviceCall", thrift.STRING, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:DeviceCall: ", p), err) }
  if err := oprot.WriteString(string(p.DeviceCall)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.DeviceCall (3) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 3:DeviceCall: ", p), err) }
  return err
}

func (p *TCallLog) writeField4(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("ListenTime", thrift.I64, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:ListenTime: ", p), err) }
  if err := oprot.WriteI64(int64(p.ListenTime)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.ListenTime (4) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 4:ListenTime: ", p), err) }
  return err
}

func (p *TCallLog) writeField5(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("PostOffice", thrift.STRING, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:PostOffice: ", p), err) }
  if err := oprot.WriteString(string(p.PostOffice)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.PostOffice (5) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 5:PostOffice: ", p), err) }
  return err
}

func (p *TCallLog) writeField6(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("PostmanId", thrift.STRING, 6); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:PostmanId: ", p), err) }
  if err := oprot.WriteString(string(p.PostmanId)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.PostmanId (6) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 6:PostmanId: ", p), err) }
  return err
}

func (p *TCallLog) writeField7(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("PostmanName", thrift.STRING, 7); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:PostmanName: ", p), err) }
  if err := oprot.WriteString(string(p.PostmanName)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.PostmanName (7) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 7:PostmanName: ", p), err) }
  return err
}

func (p *TCallLog) writeField8(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("ReceiverPhone", thrift.STRING, 8); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 8:ReceiverPhone: ", p), err) }
  if err := oprot.WriteString(string(p.ReceiverPhone)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.ReceiverPhone (8) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 8:ReceiverPhone: ", p), err) }
  return err
}

func (p *TCallLog) writeField9(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("RingTime", thrift.I64, 9); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 9:RingTime: ", p), err) }
  if err := oprot.WriteI64(int64(p.RingTime)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.RingTime (9) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 9:RingTime: ", p), err) }
  return err
}

func (p *TCallLog) writeField10(oprot thrift.TProtocol) (err error) {
...
func (p *TCallLog) writeField11(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("CallType", thrift.STRING, 11); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 11:CallType: ", p), err) }
  if err := oprot.WriteString(string(p.CallType)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.CallType (11) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 11:CallType: ", p), err) }
  return err
}

func (p *TCallLog) writeField12(oprot thrift.TProtocol) (err error) {
...
func (p *TCallLog) writeField13(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("Source", thrift.STRING, 13); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 13:Source: ", p), err) }
  if err := oprot.WriteString(string(p.Source)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.Source (13) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 13:Source: ", p), err) }
  return err
}

func (p *TCallLog) writeField14(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("Timestamp", thrift.I64, 14); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 14:Timestamp: ", p), err) }
  if err := oprot.WriteI64(int64(p.Timestamp)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.Timestamp (14) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 14:Timestamp: ", p), err) }
  return err
}

func (p *TCallLog) writeField15(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("mapExt", thrift.MAP, 15); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 15:mapExt: ", p), err) }
  if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRING, len(p.MapExt)); err != nil {
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 15:mapExt: ", p), err) }
  return err
}

func (p *TCallLog) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TCallLog(%+v)", *p)
}
...
type TDataResult_ struct {
  ...
  Data *TCallLog `thrift:"data,2" db:"data" json:"data,omitempty"`
}
...
var TDataResult__Data_DEFAULT *TCallLog
func (p *TDataResult_) GetData() *TCallLog {
  if !p.IsSetData() {
...
type TDataService interface {
  ...
  // Parameters:
  //  - Keys
  GetMultiData(ctx context.Context, keys []TKey) (r map[TKey]*TCallLog, err error)
  // Parameters:
  //  - Key
  //  - Data
  PutData(ctx context.Context, key TKey, data *TCallLog) (r TErrorCode, err error)
}
...
// Parameters:
//  - Keys
func (p *TDataServiceClient) GetMultiData(ctx context.Context, keys []TKey) (r map[TKey]*TCallLog, err error) {
  var _args9 TDataServiceGetMultiDataArgs
  _args9.Keys = keys
  var _result10 TDataServiceGetMultiDataResult
  if err = p.Client_().Call(ctx, "getMultiData", &_args9, &_result10); err != nil {
    return
  }
...
//  - Key
//  - Data
func (p *TDataServiceClient) PutData(ctx context.Context, key TKey, data *TCallLog) (r TErrorCode, err error) {
...
type TDataServiceGetMultiDataResult struct {
  Success map[TKey]*TCallLog `thrift:"success,0" db:"success" json:"success,omitempty"`
}
...
var TDataServiceGetMultiDataResult_Success_DEFAULT map[TKey]*TCallLog

func (p *TDataServiceGetMultiDataResult) GetSuccess() map[TKey]*TCallLog {
  return p.Success
}
...
func (p *TDataServiceGetMultiDataResult)  ReadField0(iprot thrift.TProtocol) error {
  ...
  tMap := make(map[TKey]*TCallLog, size)
  p.Success =  tMap
  for i := 0; i < size; i ++ {
var _key16 TKey
    if v, err := iprot.ReadString(); err != nil {
...
type TDataServicePutDataArgs struct {
  Key TKey `thrift:"key,1" db:"key" json:"key"`
  Data *TCallLog `thrift:"data,2" db:"data" json:"data"`
}
...
var TDataServicePutDataArgs_Data_DEFAULT *TCallLog
func (p *TDataServicePutDataArgs) GetData() *TCallLog {
  if !p.IsSetData() {
...
type TCallLogService interface {
TDataService
}

type TCallLogServiceClient struct {
  *TDataServiceClient
}

func NewTCallLogServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *TCallLogServiceClient {
  return &TCallLogServiceClient{TDataServiceClient: NewTDataServiceClientFactory(t, f)}}

func NewTCallLogServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *TCallLogServiceClient {
  return &TCallLogServiceClient{TDataServiceClient: NewTDataServiceClientProtocol(t, iprot, oprot)}
}

func NewTCallLogServiceClient(c thrift.TClient) *TCallLogServiceClient {
  return &TCallLogServiceClient{
    TDataServiceClient: NewTDataServiceClient(c),
  }
}

type TCallLogServiceProcessor struct {
  *TDataServiceProcessor
}

func NewTCallLogServiceProcessor(handler TCallLogService) *TCallLogServiceProcessor {
  self32 := &TCallLogServiceProcessor{NewTDataServiceProcessor(handler)}
  return self32
}
