...
func (p TChildItemOptions) String() string {
	switch p {
	case TChildItemOptions_EFree:
		return "EFree"
	case TChildItemOptions_EDistinct:
		return "EDistinct"
	case TChildItemOptions_EUnSort:
		return "EUnSort"
	case TChildItemOptions_EGetOldChildren:
		return "EGetOldChildren"
	case TChildItemOptions_EGetChildren:
		return "EGetChildren"
	case TChildItemOptions_EGetOldChildrenEDistinct:
		return "EGetOldChildrenEDistinct"
	case TChildItemOptions_EGetChildrenEDisttinct:
		return "EGetChildrenEDisttinct"
	}
	return "<UNSET>"
}
...
func TChildItemOptionsFromString(s string) (TChildItemOptions, error) {
	switch s {
	case "EFree":
		return TChildItemOptions_EFree, nil
	case "EDistinct":
		return TChildItemOptions_EDistinct, nil
	case "EUnSort":
		return TChildItemOptions_EUnSort, nil
	case "EGetOldChildren":
		return TChildItemOptions_EGetOldChildren, nil
	case "EGetChildren":
		return TChildItemOptions_EGetChildren, nil
	case "EGetOldChildrenEDistinct":
		return TChildItemOptions_EGetOldChildrenEDistinct, nil
	case "EGetChildrenEDisttinct":
		return TChildItemOptions_EGetChildrenEDisttinct, nil
	}
