...
type TNotifyStorage struct {
  ...
  Seen bool `thrift:"seen,5" db:"seen" json:"seen"`
  MapExt map[string]string `thrift:"mapExt,6" db:"mapExt" json:"mapExt"`
  Deleted bool `thrift:"deleted,7" db:"deleted" json:"deleted"`
  App string `thrift:"app,8" db:"app" json:"app"`
  Icon string `thrift:"icon,9" db:"icon" json:"icon"`
...
func NewTNotifyStorage() *TNotifyStorage {
  return &TNotifyStorage{}
}


func (p *TNotifyStorage) GetID() TKey {
  return p.ID
}

func (p *TNotifyStorage) GetSenderID() int64 {
  return p.SenderID
}

func (p *TNotifyStorage) GetReceiverID() int64 {
  return p.ReceiverID
}

func (p *TNotifyStorage) GetAction() string {
  return p.Action
}

func (p *TNotifyStorage) GetSeen() bool {
  return p.Seen
}

func (p *TNotifyStorage) GetMapExt() map[string]string {
  return p.MapExt
}

func (p *TNotifyStorage) GetDeleted() bool {
  return p.Deleted
}

func (p *TNotifyStorage) GetApp() string {
  return p.App
}

func (p *TNotifyStorage) GetIcon() string {
  return p.Icon
}

func (p *TNotifyStorage) GetTimestamp() int64 {
  return p.Timestamp
}

func (p *TNotifyStorage) GetTitle() string {
  return p.Title
}

func (p *TNotifyStorage) GetContent() string {
  return p.Content
}
func (p *TNotifyStorage) Read(iprot thrift.TProtocol) error {
...
func (p *TNotifyStorage)  ReadField1(iprot thrift.TProtocol) error {
...
func (p *TNotifyStorage)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TNotifyStorage)  ReadField3(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TNotifyStorage)  ReadField4(iprot thrift.TProtocol) error {
...
func (p *TNotifyStorage)  ReadField5(iprot thrift.TProtocol) error {
...
func (p *TNotifyStorage)  ReadField6(iprot thrift.TProtocol) error {
...
func (p *TNotifyStorage)  ReadField7(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(); err != nil {
...
func (p *TNotifyStorage)  ReadField8(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TNotifyStorage)  ReadField9(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TNotifyStorage)  ReadField10(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TNotifyStorage)  ReadField11(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TNotifyStorage)  ReadField12(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TNotifyStorage) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("TNotifyStorage"); err != nil {
...
func (p *TNotifyStorage) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *TNotifyStorage) writeField2(oprot thrift.TProtocol) (err error) {
  ...
  if err := oprot.WriteI64(int64(p.SenderID)); err != nil {
...
func (p *TNotifyStorage) writeField3(oprot thrift.TProtocol) (err error) {
  ...
  if err := oprot.WriteI64(int64(p.ReceiverID)); err != nil {
...
func (p *TNotifyStorage) writeField4(oprot thrift.TProtocol) (err error) {
...
func (p *TNotifyStorage) writeField5(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("seen", thrift.BOOL, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:seen: ", p), err) }
  if err := oprot.WriteBool(bool(p.Seen)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.seen (5) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 5:seen: ", p), err) }
  return err
}

func (p *TNotifyStorage) writeField6(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("mapExt", thrift.MAP, 6); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:mapExt: ", p), err) }
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 6:mapExt: ", p), err) }
  return err
}

func (p *TNotifyStorage) writeField7(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("deleted", thrift.BOOL, 7); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:deleted: ", p), err) }
  if err := oprot.WriteBool(bool(p.Deleted)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.deleted (7) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 7:deleted: ", p), err) }
  return err
}

func (p *TNotifyStorage) writeField8(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("app", thrift.STRING, 8); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 8:app: ", p), err) }
  if err := oprot.WriteString(string(p.App)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.app (8) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 8:app: ", p), err) }
  return err
}

func (p *TNotifyStorage) writeField9(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("icon", thrift.STRING, 9); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 9:icon: ", p), err) }
  if err := oprot.WriteString(string(p.Icon)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.icon (9) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 9:icon: ", p), err) }
  return err
}

func (p *TNotifyStorage) writeField10(oprot thrift.TProtocol) (err error) {
...
func (p *TNotifyStorage) writeField11(oprot thrift.TProtocol) (err error) {
...
func (p *TNotifyStorage) writeField12(oprot thrift.TProtocol) (err error) {
...
func (p *TNotifyStorage) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TNotifyStorage(%+v)", *p)
}
...
type TDataResult_ struct {
  ...
  Data *TNotifyStorage `thrift:"data,2" db:"data" json:"data,omitempty"`
}
...
var TDataResult__Data_DEFAULT *TNotifyStorage
func (p *TDataResult_) GetData() *TNotifyStorage {
  if !p.IsSetData() {
...
type TDataService interface {
  ...
  //  - Key
  //  - Data
  PutData(ctx context.Context, key TKey, data *TNotifyStorage) (r TErrorCode, err error)
  // Parameters:
  //  - Keys
  GetMultiData(ctx context.Context, keys []TKey) (r map[TKey]*TNotifyStorage, err error)
}
...
//  - Key
//  - Data
func (p *TDataServiceClient) PutData(ctx context.Context, key TKey, data *TNotifyStorage) (r TErrorCode, err error) {
...
// Parameters:
//  - Keys
func (p *TDataServiceClient) GetMultiData(ctx context.Context, keys []TKey) (r map[TKey]*TNotifyStorage, err error) {
...
var retval map[TKey]*TNotifyStorage
  var err2 error
...
type TDataServicePutDataArgs struct {
  Key TKey `thrift:"key,1" db:"key" json:"key"`
  Data *TNotifyStorage `thrift:"data,2" db:"data" json:"data"`
}
...
var TDataServicePutDataArgs_Data_DEFAULT *TNotifyStorage
func (p *TDataServicePutDataArgs) GetData() *TNotifyStorage {
  if !p.IsSetData() {
...
type TDataServiceGetMultiDataResult struct {
  Success map[TKey]*TNotifyStorage `thrift:"success,0" db:"success" json:"success,omitempty"`
}
...
var TDataServiceGetMultiDataResult_Success_DEFAULT map[TKey]*TNotifyStorage

func (p *TDataServiceGetMultiDataResult) GetSuccess() map[TKey]*TNotifyStorage {
  return p.Success
}
...
func (p *TDataServiceGetMultiDataResult)  ReadField0(iprot thrift.TProtocol) error {
  ...
  tMap := make(map[TKey]*TNotifyStorage, size)
  p.Success =  tMap
  for i := 0; i < size; i ++ {
var _key16 TKey
    if v, err := iprot.ReadI64(); err != nil {
...
func NewTNotifyStorageServiceProcessor(handler TNotifyStorageService) *TNotifyStorageServiceProcessor {
  self32 := &TNotifyStorageServiceProcessor{NewTDataServiceProcessor(handler)}
  return self32
}
