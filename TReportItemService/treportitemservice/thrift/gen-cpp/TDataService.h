...
class TDataServiceIf {
 public:
  ...
  virtual TErrorCode::type putData(const int64_t key, const TReportItem& data) = 0;
...
class TDataServiceNull : virtual public TDataServiceIf {
 public:
  ...
  TErrorCode::type putData(const int64_t /* key */, const TReportItem& /* data */) {
...
class TDataServiceClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type putData(const int64_t key, const TReportItem& data);
  void send_putData(const int64_t key, const TReportItem& data);
...
class TDataServiceConcurrentClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type putData(const int64_t key, const TReportItem& data);
  int32_t send_putData(const int64_t key, const TReportItem& data);
