...
type TReportItem struct {
	...
	ReportType   int64             `thrift:"reportType,4" db:"reportType" json:"reportType"`
	UID          int64             `thrift:"uid,5" db:"uid" json:"uid"`
	Timestamps   int64             `thrift:"timestamps,6" db:"timestamps" json:"timestamps"`
	IsDelete     bool              `thrift:"isDelete,7" db:"isDelete" json:"isDelete"`
	MapExtend    map[string]string `thrift:"mapExtend,8" db:"mapExtend" json:"mapExtend"`
	MarketitemID int64             `thrift:"marketitemID,9" db:"marketitemID" json:"marketitemID"`
}
...
func (p *TReportItem) GetID() int64 {
	return p.ID
}

func (p *TReportItem) GetTitle() string {
	return p.Title
}

func (p *TReportItem) GetContent() string {
	return p.Content
}

func (p *TReportItem) GetReportType() int64 {
	return p.ReportType
}
...
func (p *TReportItem) GetTimestamps() int64 {
	return p.Timestamps
}

func (p *TReportItem) GetIsDelete() bool {
	return p.IsDelete
}

func (p *TReportItem) GetMapExtend() map[string]string {
	return p.MapExtend
}

func (p *TReportItem) GetMarketitemID() int64 {
	return p.MarketitemID
}
...
func (p *TReportItem) writeField4(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("reportType", thrift.I64, 4); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:reportType: ", p), err)
	}
	if err := oprot.WriteI64(int64(p.ReportType)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.reportType (4) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 4:reportType: ", p), err)
	}
	return err
}
...
func (p *TReportItem) writeField7(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("isDelete", thrift.BOOL, 7); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:isDelete: ", p), err)
	}
	if err := oprot.WriteBool(bool(p.IsDelete)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.isDelete (7) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 7:isDelete: ", p), err)
	}
	return err
}
...
func (p *TReportItem) writeField9(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("marketitemID", thrift.I64, 9); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 9:marketitemID: ", p), err)
	}
	if err := oprot.WriteI64(int64(p.MarketitemID)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.marketitemID (9) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 9:marketitemID: ", p), err)
	}
	return err
}
...
type TDataService interface {
	...
	//  - Key
	//  - Data
	PutData(ctx context.Context, key int64, data *TReportItem) (r TErrorCode, err error)
	// Parameters:
	//  - Key
...
//  - Key
//  - Data
func (p *TDataServiceClient) PutData(ctx context.Context, key int64, data *TReportItem) (r TErrorCode, err error) {
...
var TDataServicePutDataArgs_Data_DEFAULT *TReportItem

func (p *TDataServicePutDataArgs) GetData() *TReportItem {
	if !p.IsSetData() {
...
type TReportItemService interface {
	TDataService
}

type TReportItemServiceClient struct {
	*TDataServiceClient
}

func NewTReportItemServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *TReportItemServiceClient {
	return &TReportItemServiceClient{TDataServiceClient: NewTDataServiceClientFactory(t, f)}
}

func NewTReportItemServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *TReportItemServiceClient {
	return &TReportItemServiceClient{TDataServiceClient: NewTDataServiceClientProtocol(t, iprot, oprot)}
}

func NewTReportItemServiceClient(c thrift.TClient) *TReportItemServiceClient {
	return &TReportItemServiceClient{
		TDataServiceClient: NewTDataServiceClient(c),
	}
}

type TReportItemServiceProcessor struct {
	*TDataServiceProcessor
}

func NewTReportItemServiceProcessor(handler TReportItemService) *TReportItemServiceProcessor {
	self34 := &TReportItemServiceProcessor{NewTDataServiceProcessor(handler)}
	return self34
}
