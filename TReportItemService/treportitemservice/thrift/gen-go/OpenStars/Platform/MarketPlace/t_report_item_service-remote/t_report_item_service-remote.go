...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  TErrorCode putData(i64 key, TReportItem data)")
...
func main() {
  ...
  client := MarketPlace.NewTReportItemServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "putData":
    ...
    argvalue1 := MarketPlace.NewTReportItem()
  ...
  case "getListData":
    ...
    containerStruct0 := MarketPlace.NewTReportItemServiceGetListDataArgs()
