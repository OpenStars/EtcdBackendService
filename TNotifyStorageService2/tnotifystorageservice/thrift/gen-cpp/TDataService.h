...
class TDataServiceIf {
 public:
  ...
  virtual void getData(TDataResult& _return, const int64_t key) = 0;
  virtual TErrorCode::type putData(const int64_t key, const TNotifyItem& data) = 0;
  virtual void getListData(TListDataResult& _return, const std::vector<int64_t> & lskeys) = 0;
  virtual bool removeData(const int64_t key) = 0;
};
...
class TDataServiceNull : virtual public TDataServiceIf {
 public:
  ...
  void getData(TDataResult& /* _return */, const int64_t /* key */) {
    return;
  }
  TErrorCode::type putData(const int64_t /* key */, const TNotifyItem& /* data */) {
    TErrorCode::type _return = (TErrorCode::type)0;
    return _return;
  }
  void getListData(TListDataResult& /* _return */, const std::vector<int64_t> & /* lskeys */) {
    return;
  }
  bool removeData(const int64_t /* key */) {
    bool _return = false;
    return _return;
  }
};
...
typedef struct _TDataService_getListData_args__isset {
  _TDataService_getListData_args__isset() : lskeys(false) {}
  bool lskeys :1;
...
class TDataService_getListData_pargs {
 public:
  ...
  const std::vector<int64_t> * lskeys;
...
class TDataService_removeData_args {
 public:
  ...
  virtual ~TDataService_removeData_args() throw();
  int64_t key;
...
class TDataService_removeData_pargs {
 public:
  ...
  virtual ~TDataService_removeData_pargs() throw();
  const int64_t* key;
...
class TDataService_removeData_result {
 public:
  ...
  TDataService_removeData_result() : success(0) {
  }

  virtual ~TDataService_removeData_result() throw();
  bool success;
...
class TDataService_removeData_presult {
 public:
  ...
  virtual ~TDataService_removeData_presult() throw();
  bool* success;
...
class TDataServiceClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  void getData(TDataResult& _return, const int64_t key);
  void send_getData(const int64_t key);
  void recv_getData(TDataResult& _return);
  TErrorCode::type putData(const int64_t key, const TNotifyItem& data);
  void send_putData(const int64_t key, const TNotifyItem& data);
  TErrorCode::type recv_putData();
  void getListData(TListDataResult& _return, const std::vector<int64_t> & lskeys);
  void send_getListData(const std::vector<int64_t> & lskeys);
  void recv_getListData(TListDataResult& _return);
  bool removeData(const int64_t key);
  void send_removeData(const int64_t key);
...
class TDataServiceMultiface : virtual public TDataServiceIf {
 ...
 public:
  ...
  void getListData(TListDataResult& _return, const std::vector<int64_t> & lskeys) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->getListData(_return, lskeys);
    }
    ifaces_[i]->getListData(_return, lskeys);
    return;
  }
...
class TDataServiceConcurrentClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  void getData(TDataResult& _return, const int64_t key);
  int32_t send_getData(const int64_t key);
  void recv_getData(TDataResult& _return, const int32_t seqid);
  TErrorCode::type putData(const int64_t key, const TNotifyItem& data);
  int32_t send_putData(const int64_t key, const TNotifyItem& data);
  TErrorCode::type recv_putData(const int32_t seqid);
  void getListData(TListDataResult& _return, const std::vector<int64_t> & lskeys);
  int32_t send_getListData(const std::vector<int64_t> & lskeys);
  void recv_getListData(TListDataResult& _return, const int32_t seqid);
  bool removeData(const int64_t key);
  int32_t send_removeData(const int64_t key);
