...
class TDataService_getListDatas_args {
 public:
  ...
  virtual ~TDataService_getListDatas_args() throw();
...
class TDataService_getListDatas_pargs {
 public:
  ...
  virtual ~TDataService_getListDatas_pargs() throw();
...
class TDataService_getListDatas_result {
 public:
  ...
  virtual ~TDataService_getListDatas_result() throw();
...
class TDataService_getListDatas_presult {
 public:
  ...
  virtual ~TDataService_getListDatas_presult() throw();
  TListDataResult* success;
