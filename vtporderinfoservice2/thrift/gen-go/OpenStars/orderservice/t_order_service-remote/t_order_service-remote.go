...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "   getMultiData( keys)")
  fmt.Fprintln(os.Stderr, "  TErrorCode putData(TKey key, TOrder data)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := orderservice.NewTOrderServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "getData":
    ...
    value0 := orderservice.TKey(argvalue0)
  ...
  case "getMultiData":
    ...
    containerStruct0 := orderservice.NewTOrderServiceGetMultiDataArgs()
    ...
    value0 := argvalue0
    fmt.Print(client.GetMultiData(context.Background(), value0))
    fmt.Print("\n")
    break
  case "putData":
    if flag.NArg() - 1 != 2 {
    ...
    argvalue1 := orderservice.NewTOrder()
