...
type TVTPComment struct {
  ...
  MaBuugui string `thrift:"ma_buugui,6" db:"ma_buugui" json:"ma_buugui"`
}
...
func (p *TVTPComment) GetMaBuugui() string {
  return p.MaBuugui
}
...
func (p *TVTPComment)  ReadField6(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TVTPComment) writeField6(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("ma_buugui", thrift.STRING, 6); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:ma_buugui: ", p), err) }
  if err := oprot.WriteString(string(p.MaBuugui)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.ma_buugui (6) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 6:ma_buugui: ", p), err) }
  return err
}
