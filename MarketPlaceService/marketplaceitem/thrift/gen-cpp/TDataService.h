...
class TDataServiceIf {
 public:
  ...
  virtual TErrorCode::type putData(const int64_t key, const TMarketPlaceItem& data) = 0;
  virtual TErrorCode::type removeData(const int64_t key) = 0;
  virtual void getListData(TListDataResult& _return, const std::vector<int64_t> & key) = 0;
};
...
class TDataServiceNull : virtual public TDataServiceIf {
 public:
  ...
  TErrorCode::type putData(const int64_t /* key */, const TMarketPlaceItem& /* data */) {
    TErrorCode::type _return = (TErrorCode::type)0;
    return _return;
  }
  TErrorCode::type removeData(const int64_t /* key */) {
    TErrorCode::type _return = (TErrorCode::type)0;
    return _return;
  }
  void getListData(TListDataResult& /* _return */, const std::vector<int64_t> & /* key */) {
    return;
  }
};
...
typedef struct _TDataService_getListData_args__isset {
  _TDataService_getListData_args__isset() : key(false) {}
  bool key :1;
...
class TDataService_getListData_args {
 public:
  ...
  virtual ~TDataService_getListData_args() noexcept;
  std::vector<int64_t>  key;

  _TDataService_getListData_args__isset __isset;

  void __set_key(const std::vector<int64_t> & val);
...
class TDataService_getListData_pargs {
 public:
  ...
  virtual ~TDataService_getListData_pargs() noexcept;
...
class TDataService_getListData_result {
 public:
  ...
  virtual ~TDataService_getListData_result() noexcept;
...
class TDataService_getListData_presult {
 public:
  ...
  virtual ~TDataService_getListData_presult() noexcept;
  TListDataResult* success;
...
class TDataServiceClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type putData(const int64_t key, const TMarketPlaceItem& data);
  void send_putData(const int64_t key, const TMarketPlaceItem& data);
  TErrorCode::type recv_putData();
  TErrorCode::type removeData(const int64_t key);
  void send_removeData(const int64_t key);
  TErrorCode::type recv_removeData();
  void getListData(TListDataResult& _return, const std::vector<int64_t> & key);
  void send_getListData(const std::vector<int64_t> & key);
...
class TDataServiceMultiface : virtual public TDataServiceIf {
 ...
 public:
  ...
  void getListData(TListDataResult& _return, const std::vector<int64_t> & key) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->getListData(_return, key);
    }
    ifaces_[i]->getListData(_return, key);
    return;
  }
  ...
  TDataServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  TErrorCode::type putData(const int64_t key, const TMarketPlaceItem& data);
  int32_t send_putData(const int64_t key, const TMarketPlaceItem& data);
  ...
  void getListData(TListDataResult& _return, const std::vector<int64_t> & key);
  int32_t send_getListData(const std::vector<int64_t> & key);
